...
public class Show {
    ...
    int numberOfSeasons;
    boolean isCompleted;
    ArrayList<String> audioLanguage;

    public Show(String name, int numberOfSeasons, boolean isCompleted) {
        this.name = name;
        this.numberOfSeasons = numberOfSeasons;
        this.isCompleted = isCompleted;
        audioLanguage = new ArrayList<>();

    }

    public Show(String name, int numberOfSeasons, boolean isCompleted, ArrayList<String> audioLanguage) {
       this(name, numberOfSeasons, isCompleted);
       this.audioLanguage.addAll(audioLanguage);
    }
